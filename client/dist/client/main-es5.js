(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminGuard = /** @class */ (function () {
                function AdminGuard(webService, authService, router) {
                ...
                AdminGuard.prototype.canActivate = function () {
                    var _this = this;
                    return this.webService.get("users/" + this.authService.getUserId()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
                        if (res.body.isAdmin)
                            return true;
                ...
                WebReqInterceptor.prototype.intercept = function (request, next) {
                    ...
                    return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        if (error.status === 401) {
                            ...
                            return _this.refreshAccessToken().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccountDetailsComponent = /** @class */ (function () {
                function AccountDetailsComponent(route, usersService, dialog, authService, router) {
                    this.route = route;
                ...
                AccountDetailsComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.paramMap.subscribe(function (paramMap) {
                        ...
                        _this.usersService.getUser(_this.userId).subscribe(function (user) {
                            _this.user = user;
                            if (_this.userId === _this.authService.getUserId())
                                _this.canEdit = true;
                        }, function () { return _this.router.navigate(["/"]); });
                    });
                };
                AccountDetailsComponent.prototype.editInfo = function (infoType) {
                    var _this = this;
                    var dialogRef = this.dialog.open(_components_edit_form_edit_form_component__WEBPACK_IMPORTED_MODULE_4__["EditFormComponent"], {
                        width: "580px",
                        data: { user: this.user, infoType: infoType }
                    });
                    dialogRef.afterClosed().subscribe(function (result) {
                        if (result) {
                            _this.usersService
                                .updateUser(_this.userId, { result: result })
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditFormComponent = /** @class */ (function () {
                function EditFormComponent(dialogRef, data) {
                ...
                EditFormComponent.prototype.updatePersonalInfo = function () {
                ...
                EditFormComponent.prototype.updateAddressDetails = function () {
                    this.dialogRef.close({
                        address: {
            ...
            var PersonalInformations = /** @class */ (function () {
                function PersonalInformations(email, firstName, lastName) {
                    this.email = email;
            ...
            var AddressDetails = /** @class */ (function () {
                function AddressDetails(street, city, country, postcode) {
                    this.street = street;
                    this.city = city;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccountPurchasesComponent = /** @class */ (function () {
                function AccountPurchasesComponent(route, router, purchasesService, productsService, authService) {
                    this.route = route;
                    this.router = router;
                ...
                AccountPurchasesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.paramMap.subscribe(function (paramMap) {
                        if (paramMap.get("id")) {
                            _this.userId = paramMap.get("id");
                            _this.purchasesService.getAllPurchasesForUser(_this.userId).subscribe(function (purchases) { return _this.initializePurchases(purchases, paramMap); }, function () { return _this.router.navigate(["/"]); });
                        }
                        else {
                            _this.isAdmin = true;
                            _this.purchasesService
                                .getAllPurchases(_this.authService.getUserId())
                                .subscribe(function (purchases) { return _this.initializePurchases(purchases, paramMap); });
                        }
                    });
                };
                AccountPurchasesComponent.prototype.initializePurchases = function (purchases, paramMap) {
                ...
                AccountPurchasesComponent.prototype.toggleShippingDetails = function (id) {
                    if (this.showShippingDetailsIds.includes(id)) {
                        var index = this.showShippingDetailsIds.indexOf(id);
                ...
                AccountPurchasesComponent.prototype.filterByName = function () {
                    var arr = [];
                ...
                AccountPurchasesComponent.prototype.selectPerPage = function (num) {
                    this.perPage = num;
                    this.setTotalPages();
                    this.currentPage = 1;
                };
                AccountPurchasesComponent.prototype.setTotalPages = function () {
                    this.totalPages = Math.ceil(this.filteredAndSortedPurchases.length / this.perPage);
                };
                AccountPurchasesComponent.prototype.setCurrentPage = function (num) {
                    this.currentPage = num;
                };
                AccountPurchasesComponent.prototype.changeSort = function (sortName) {
                    this.currentSort = sortName;
                };
                AccountPurchasesComponent.prototype.goToProduct = function (event, id) {
                ...
                AccountPurchasesComponent.prototype.generateUrlParams = function () {
                    return {
                ...
                AccountPurchasesComponent.prototype.goToUser = function (event, id) {
                    event.preventDefault();
                    this.router.navigate(["/account/" + id + "/details"]);
                };
                return AccountPurchasesComponent;
            }());
            AccountPurchasesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartComponent = /** @class */ (function () {
                function CartComponent(usersService, productsService, router) {
                    this.usersService = usersService;
                    this.productsService = productsService;
                    this.router = router;
                ...
                CartComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.cartSubscription = this.usersService.cartObs$.subscribe(function (cart) {
                        _this.cart = cart;
                ...
                CartComponent.prototype.incrementProducts = function (cartItem) {
                    var _this = this;
                    ...
                    this.quantityTimeout = window.setTimeout(function () {
                        _this.usersService
                            .addToCart(cartItem.product, cartItem.quantity)
                            .subscribe(function () { return _this.calculateTotalPrice(); });
                    }, 700);
                };
                CartComponent.prototype.decrementProducts = function (cartItem) {
                    var _this = this;
                ...
                CartComponent.prototype.validateControl = function (e, cartItem) {
                    var _this = this;
                    var numberOfProducts = cartItem.quantity;
                ...
                CartComponent.prototype.removeFromCart = function (product) {
                    ...
                    this.usersService
                        ...
                        _this.usersService.emitCart(cart.body);
                        _this.calculateTotalPrice();
                    });
                };
                ...
                CartComponent.prototype.goToProduct = function (id) {
                    this.productsService.emitUrlParams({});
                    this.router.navigate(["/product/" + id]);
                };
                CartComponent.prototype.navigateToCheckout = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CheckoutComponent = /** @class */ (function () {
                function CheckoutComponent(route, productsService, usersService, purchasesService, router) {
                    this.route = route;
                    this.productsService = productsService;
                    this.usersService = usersService;
                    this.purchasesService = purchasesService;
                ...
                CheckoutComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.userSubscription = this.usersService.loggedInUserIdObs$.subscribe(function (id) {
                        _this.userId = id;
                        _this.usersService.getUser(_this.userId).subscribe(function (user) {
                            _this.user = user;
                            _this.shippingDetails = new ShippingDetails(_this.user.name.firstName, _this.user.name.lastName, _this.user.address.street, _this.user.address.city, _this.user.address.country, _this.user.address.postcode);
                        });
                    });
                    this.route.paramMap.subscribe(function (paramMap) {
                        var productId = paramMap.get("id");
                        if (productId) {
                            _this.route.queryParamMap.subscribe(function (queryParamMap) {
                                var quantity = Number(queryParamMap.get("quantity"));
                                _this.clearCartAfterCheckout = false;
                                _this.productsService
                                    .getOneProduct(productId)
                                    .subscribe(function (product) {
                                    _this.productsToBuy.push({
                                        product: product,
                                        quantity: quantity,
                                        _userId: _this.userId,
                                        shippingDetails: _this.shippingDetails
                                    });
                                    _this.totalPrice = product.price * quantity;
                                });
                            });
                        }
                        else {
                            _this.cartSubscription = _this.usersService.cartObs$.subscribe(function (cart) {
                                if (cart.length === 0)
                                    _this.router.navigate(["/"]);
                                _this.clearCartAfterCheckout = true;
                                for (var _i = 0, cart_1 = cart; _i < cart_1.length; _i++) {
                                    var el = cart_1[_i];
                                    _this.productsToBuy.push(Object.assign({}, el, { _userId: _this.userId, shippingDetails: _this.shippingDetails }));
                                }
                                _this.calculateTotalPrice();
                            });
                        }
                ...
                CheckoutComponent.prototype.calculateTotalPrice = function () {
                    var total = 0;
                    for (var _i = 0, _a = this.productsToBuy; _i < _a.length; _i++) {
                        var el = _a[_i];
                ...
                CheckoutComponent.prototype.order = function () {
                    ...
                    this.purchasesService
                        ...
                        if (res.status === 200) {
                            if (_this.clearCartAfterCheckout)
                                _this.usersService.clearCart().subscribe();
            ...
            var ShippingDetails = /** @class */ (function () {
                function ShippingDetails(firstName, lastName, street, city, country, postcode) {
                    this.firstName = firstName;
                    this.lastName = lastName;
                    this.street = street;
                    this.city = city;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomersComponent = /** @class */ (function () {
                function CustomersComponent(usersService, authService, router) {
                    this.usersService = usersService;
                    this.authService = authService;
                    this.router = router;
                    this.currentPage = 1;
                ...
                CustomersComponent.prototype.ngOnInit = function () {
                    ...
                    this.customersSubscription = this.usersService
                        ...
                        _this.filteredAndSortedCustomers = customers;
                        _this.setTotalPages();
                    });
                };
                ...
                CustomersComponent.prototype.filterByName = function () {
                    var arr = [];
                ...
                CustomersComponent.prototype.selectPerPage = function (num) {
                    this.perPage = num;
                    this.setTotalPages();
                    this.currentPage = 1;
                };
                CustomersComponent.prototype.setTotalPages = function () {
                    this.totalPages = Math.ceil(this.filteredAndSortedCustomers.length / this.perPage);
                };
                CustomersComponent.prototype.setCurrentPage = function (num) {
                    this.currentPage = num;
                };
                CustomersComponent.prototype.changeSort = function (sortName) {
                    this.currentSort = sortName;
                };
                CustomersComponent.prototype.goToUser = function (event, id) {
                    event.preventDefault();
                    this.router.navigate(["/account/" + id + "/details"]);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemCardComponent = /** @class */ (function () {
                function ItemCardComponent(usersService, authService, productsService, dialog, router) {
                    this.usersService = usersService;
                    this.authService = authService;
                    this.productsService = productsService;
                    this.dialog = dialog;
                ...
                ItemCardComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.isLoggedInSubscription = this.authService.isLoggedInObs$.subscribe(function (isLoggedIn) { return (_this.isLoggedIn = isLoggedIn); });
                };
                ...
                ItemCardComponent.prototype.addToCart = function () {
                    ...
                    this.usersService
                        ...
                        .subscribe(function (cart) { return _this.usersService.emitCart(cart.body); });
                    this.addedToCart = true;
                };
                ItemCardComponent.prototype.removeFromCart = function () {
                    var _this = this;
                    this.usersService
                ...
                ItemCardComponent.prototype.editProduct = function (event) {
                    var _this = this;
                    event.preventDefault();
                    var dialogRef = this.dialog.open(src_app_shared_components_product_form_product_form_component__WEBPACK_IMPORTED_MODULE_5__["ProductFormComponent"], {
                        width: "580px",
                        height: "90%",
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        if (result) {
                            _this.productsService
                                .editProduct(Object.assign({}, result.product, { _id: _this.product._id }), _this.authService.getUserId())
                                .subscribe(function (res) {
                                if (res.status === 200)
                                    _this.productsService.getAllProducts();
                            });
                        }
                    });
                };
                ItemCardComponent.prototype.deleteProduct = function (event) {
                    var _this = this;
                    event.preventDefault();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(productsService, usersService, authService, router, route, dialog) {
                    this.productsService = productsService;
                    this.usersService = usersService;
                    this.authService = authService;
                    this.router = router;
                ...
                HomeComponent.prototype.initializeProducts = function () {
                    var _this = this;
                    this.productsSubscription = this.productsService.allProductsObs$.subscribe(function (allProducts) {
                        _this.allProducts = allProducts;
                        _this.filteredAndSortedProducts = allProducts;
                        _this.setTotalPages();
                        _this.filterByTagsAndName();
                        _this.route.paramMap.subscribe(function (paramMap) {
                            if (paramMap.get("perPage"))
                                _this.perPage = Number(paramMap.get("perPage"));
                            if (paramMap.get("page"))
                                _this.currentPage = Number(paramMap.get("page"));
                            if (paramMap.get("search")) {
                                _this.searchFor = paramMap.get("search");
                                _this.filterByTagsAndName();
                            }
                            if (paramMap.get("tags")) {
                                _this.currentFilters = paramMap.get("tags").split(",");
                                _this.filterByTagsAndName();
                            }
                            if (paramMap.get("sort")) {
                                _this.currentSort = paramMap.get("sort");
                            }
                        });
                    });
                };
                HomeComponent.prototype.initializeCart = function () {
                    var _this = this;
                    if (!this.authService.checkIsLoggedIn())
                        return;
                    this.cartSubscription = this.usersService.cartObs$.subscribe(function (cart) {
                        ...
                        for (var _i = 0, cart_2 = cart; _i < cart_2.length; _i++) {
                            var el = cart_2[_i];
                            _this.idsOfProductsInCart.push(el.product._id);
                        }
                    });
                };
                HomeComponent.prototype.filterByTagsAndName = function (event) {
                    var _this = this;
                    if (event) {
                        var target = event.currentTarget;
                        var idAttr = target.attributes.id;
                        var newFilterName_1 = idAttr.nodeValue;
                        if (!this.currentFilters.includes(newFilterName_1)) {
                            this.currentFilters.push(newFilterName_1);
                        }
                        else {
                            this.currentFilters = this.currentFilters.filter(function (el) { return el !== newFilterName_1; });
                        }
                        this.currentPage = 1;
                    }
                    this.filteredAndSortedProducts = this.allProducts.filter(function (product) { return _this.filterCriterium(product, _this.currentFilters); });
                    if (this.searchFor) {
                        var arr = [];
                        for (var _i = 0, _a = this.filteredAndSortedProducts; _i < _a.length; _i++) {
                            var product = _a[_i];
                ...
                HomeComponent.prototype.filterCriterium = function (product, filters) {
                    if (filters.length === 0)
                        return true;
                    return filters.includes(product.tag);
                };
                HomeComponent.prototype.clearTags = function () {
                    this.currentFilters = [];
                    this.currentPage = 1;
                    this.filterByTagsAndName();
                };
                HomeComponent.prototype.selectPerPage = function (num) {
                    this.perPage = num;
                    this.setTotalPages();
                    this.currentPage = 1;
                };
                HomeComponent.prototype.setTotalPages = function () {
                    this.totalPages = Math.ceil(this.filteredAndSortedProducts.length / this.perPage);
                };
                HomeComponent.prototype.setCurrentPage = function (num) {
                    this.currentPage = num;
                };
                HomeComponent.prototype.changeSort = function (sortName) {
                    this.currentSort = sortName;
                };
                HomeComponent.prototype.goToProduct = function (event, id) {
                    event.preventDefault();
                    this.productsService.emitBaseUrl("/products");
                    this.productsService.emitUrlParams(this.generateUrlParams());
                    this.router.navigate(["/product/" + id]);
                };
                HomeComponent.prototype.generateUrlParams = function () {
                    return {
                        page: this.currentPage,
                        perPage: this.perPage,
                ...
                HomeComponent.prototype.newProduct = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(src_app_shared_components_product_form_product_form_component__WEBPACK_IMPORTED_MODULE_7__["ProductFormComponent"], {
                        width: "580px",
                        height: "90%",
                    ...
                    dialogRef.afterClosed().subscribe(function (result) {
                        if (result) {
                            _this.productsService
                                .addNewProduct(result.product, _this.authService.getUserId())
                                .subscribe(function (res) {
                                if (res.status === 200)
                                    _this.productsService.getAllProducts();
                            });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavbarComponent = /** @class */ (function () {
                function NavbarComponent(authService, usersService) {
                    this.authService = authService;
                    this.usersService = usersService;
                    this.isActive = false;
                    this.authService.checkIsAdmin();
                ...
                NavbarComponent.prototype.deactivate = function () {
                    this.isActive = false;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductComponent = /** @class */ (function () {
                function ProductComponent(route, productsService, usersService, authService, router, dialog) {
                    var _this = this;
                    this.route = route;
                    this.productsService = productsService;
                    this.usersService = usersService;
                    ...
                    this.paramsSubscription = this.productsService.urlToReturnParamsObs$.subscribe(function (params) { return (_this.urlToReturnParams = params); });
                    this.urlSubscription = this.productsService.baseUrlToReturnObs$.subscribe(function (url) { return (_this.baseUrlToReturn = url); });
                    this.isAdmin$ = this.authService.isAdminObs$;
                    this.authService.checkIsAdmin();
                }
                ProductComponent.prototype.ngOnInit = function () {
                    ...
                    this.productsService.getOneProduct(productId).subscribe(function (product) {
                        if (!product)
                            _this.router.navigate(["/"]);
                        _this.product = product;
                        var fixedUrl = _this.product.imageUrl.replace("medium", "new-big");
                        _this.product.imageUrl = fixedUrl;
                    }, function () { return _this.router.navigate(["/"]); });
                };
                ...
                ProductComponent.prototype.incrementProducts = function () {
                    this.numberOfProducts++;
                };
                ProductComponent.prototype.decrementProducts = function () {
                    if (this.numberOfProducts === 1)
                        return;
                    this.numberOfProducts--;
                };
                ProductComponent.prototype.validateControl = function (e) {
                    if (!Number.isInteger(Number(e.target.value))) {
                ...
                ProductComponent.prototype.addToCart = function () {
                    ...
                    setTimeout(function () {
                        _this.showAddedToCartMessage = false;
                    }, 800);
                };
                ...
                ProductComponent.prototype.deleteProduct = function () {
                    ...
                    this.productsService
                        ...
                        if (res.status === 200) {
                            if (confirm("Do you want to permanently delete the product?")) {
                                if (_this.baseUrlToReturn) {
                                    _this.router.navigate([
                                        _this.baseUrlToReturn,
                                        _this.urlToReturnParams
                                    ]);
                                }
                                else
                                    _this.router.navigate(["/"]);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var UserAuthControlComponent = /** @class */ (function () {
                function UserAuthControlComponent() {
                }
                return UserAuthControlComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ForgotPasswordComponent = /** @class */ (function () {
                ...
                ForgotPasswordComponent.prototype.onSubmit = function () {
                    ...
                    this.authService.forgotPassword(email).subscribe(function (res) {
                        if (res.status === 200) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.authService.login(email, password, remember).subscribe(function (res) {
                        if (res.status === 200) {
                            _this.usersService.userId = _this.authService.getUserId();
                            _this.usersService.getCart();
                            _this.router.navigate(["/"]);
                        }
                    }, function (err) {
                        if (err)
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResetPasswordComponent = /** @class */ (function () {
                function ResetPasswordComponent(authService, route, router) {
                    this.authService = authService;
                    this.route = route;
                    this.router = router;
                    this.displayErrorMessage = false;
                ...
                ResetPasswordComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.paramMap.subscribe(function (params) {
                        ...
                        _this.authService.checkToken(token).subscribe(function (res) {
                            if (res.status === 200)
                                _this.userEmail = res.body.email;
                        }, function (err) {
                            if (err)
                ...
                ResetPasswordComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var newPassword = this.resetForm.get("password").value;
                    if (newPassword !== this.resetForm.get("confirmPassword").value)
                        return;
                    this.authService.resetPassword(this.userEmail, newPassword).subscribe(function (res) {
                        if (res.status === 200) {
                            _this.displayErrorMessage = false;
                            _this.displaySuccessMessage = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(authService, usersService, router) {
                    this.authService = authService;
                    this.usersService = usersService;
                    this.router = router;
                }
                ...
                SignupComponent.prototype.onSubmit = function () {
                    ...
                    this.authService.signup(email, password).subscribe(function (res) {
                        ...
                        if (err && err.error.code === 11000) {
                            _this.errorMessage = "This email address is already in use";
                        }
                        else if (err)
                            _this.errorMessage = "Something went wrong. Please try again later";
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserAuthPagesRoutingModule = /** @class */ (function () {
                function UserAuthPagesRoutingModule() {
                }
                return UserAuthPagesRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserAuthPagesModule = /** @class */ (function () {
                function UserAuthPagesModule() {
                }
                return UserAuthPagesModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.emitIsLoggedIn = function (loggedInStatus) {
                    this.isLoggedIn.next(loggedInStatus);
                };
                AuthService.prototype.emitIsAdmin = function (adminStatus) {
                ...
                AuthService.prototype.login = function (email, password, remember) {
                    ...
                    return this.webService.login(email, password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["shareReplay"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (res) {
                        ...
                        _this.setSession(res.body._id, res.headers.get("x-access-token"), res.headers.get("x-refresh-token"), remember);
                        _this.emitIsAdmin(res.body.isAdmin);
                        _this.emitIsLoggedIn(true);
                    }));
                };
                ...
                AuthService.prototype.checkIsLoggedIn = function () {
                    if (this.getAccessToken())
                        return true;
                    return false;
                };
                AuthService.prototype.checkIsAdmin = function () {
                    var _this = this;
                    this.webService
                        .get("users/" + this.getUserId())
                        .subscribe(function (res) { return _this.emitIsAdmin(res.body.isAdmin); });
                };
                AuthService.prototype.setSession = function (userId, accessToken, refreshToken, remember) {
                    if (remember === void 0) { remember = true; }
                    if (remember) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductsService = /** @class */ (function () {
                function ProductsService(webService) {
                    this.webService = webService;
                ...
                ProductsService.prototype.emitAllProducts = function (products) {
                    this.allProducts.next(products);
                };
                ProductsService.prototype.emitUrlParams = function (params) {
                    this.urlToReturnParams.next(params);
                };
                ProductsService.prototype.emitBaseUrl = function (url) {
                ...
                ProductsService.prototype.getAllProducts = function () {
                    ...
                    this.webService
                        .get("products")
                        .subscribe(function (res) { return _this.emitAllProducts(res.body); });
                };
                ...
                ProductsService.prototype.addNewProduct = function (product, adminId) {
                    return this.webService.post("products", product, { _id: adminId });
                };
                ProductsService.prototype.editProduct = function (product, adminId) {
                    return this.webService.patch("products", product, { _id: adminId });
                };
                ProductsService.prototype.deleteProduct = function (productId, adminId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PurchasesService = /** @class */ (function () {
                function PurchasesService(webService) {
                    this.webService = webService;
                }
                PurchasesService.prototype.getAllPurchases = function (adminId) {
                    return this.webService
                        .get("purchases", { _id: adminId })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.body; }));
                };
                PurchasesService.prototype.getAllPurchasesForUser = function (userId) {
                    return this.webService
                        .get("purchases/" + userId)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.body; }));
                };
                PurchasesService.prototype.makePurchase = function (arrayOfPurchases) {
                    return this.webService.post("purchases", { arrayOfPurchases: arrayOfPurchases });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersService = /** @class */ (function () {
                function UsersService(authService, webService) {
                    var _this = this;
                    this.authService = authService;
                    this.webService = webService;
                    ...
                    this.loggedInUserIdObs$.subscribe(function (id) { return (_this.userId = id); });
                    this.authService.isLoggedInObs$.subscribe(function (status) {
                        if (status)
                            _this.emitLoggedInUserId(_this.authService.getUserId());
                        else
                            _this.emitLoggedInUserId("");
                    });
                }
                UsersService.prototype.emitCart = function (cart) {
                    this.cart.next(cart);
                };
                UsersService.prototype.emitLoggedInUserId = function (id) {
                    this.loggedInUserId.next(id);
                };
                UsersService.prototype.getUser = function (id) {
                    return this.webService
                        .get("users/" + id)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) { return res.body; }));
                };
                UsersService.prototype.getAllUsers = function (adminId) {
                    return this.webService
                        .get("users", { _id: adminId })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) { return res.body; }));
                };
                UsersService.prototype.updateUser = function (id, payload) {
                    return this.webService
                        .patch("users/" + id, payload)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) { return res.body; }));
                };
                UsersService.prototype.getCart = function () {
                    var _this = this;
                    this.webService
                        .get("users/" + this.userId + "/cart")
                        .subscribe(function (res) { return _this.emitCart(res.body); });
                };
                UsersService.prototype.addToCart = function (product, quantity) {
                ...
                UsersService.prototype.removeFromCart = function (product) {
                    return this.webService.patch("users/cart/remove", {
                        userId: this.userId,
                        product: product
                    });
                };
                UsersService.prototype.clearCart = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WebRequestService = /** @class */ (function () {
                ...
                WebRequestService.prototype.get = function (uri, headers) {
                ...
                WebRequestService.prototype.post = function (uri, payload, headers) {
                    if (headers === void 0) { headers = ""; }
                ...
                WebRequestService.prototype.patch = function (uri, payload, headers) {
                    if (headers === void 0) { headers = ""; }
                ...
                WebRequestService.prototype.delete = function (uri, headers) {
                    if (headers === void 0) { headers = ""; }
                ...
                WebRequestService.prototype.forgotPassword = function (email) {
                    return this.http.post("/users/forgot-password", { email: email }, { observe: "response" });
                };
                WebRequestService.prototype.resetPassword = function (email, password) {
                    return this.http.patch("/users/reset-password", { email: email, password: password }, { observe: "response" });
                };
                WebRequestService.prototype.checkToken = function (token) {
                    return this.http.post("/users/reset/check-token", { token: token }, { observe: "response" });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainPaginationComponent = /** @class */ (function () {
                function MainPaginationComponent(cdRef) {
                    this.cdRef = cdRef;
                    this.currentPage = 1;
                    this.pageChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                MainPaginationComponent.prototype.ngAfterViewChecked = function () {
                    this.cdRef.detectChanges();
                };
                MainPaginationComponent.prototype.nextPage = function () {
                    if (this.currentPage < this.totalPages)
                        this.currentPage++;
                    this.changePage();
                };
                MainPaginationComponent.prototype.previousPage = function () {
                    if (this.currentPage > 1)
                        this.currentPage--;
                    this.changePage();
                };
                MainPaginationComponent.prototype.goToPage = function (pageAsString) {
                    this.currentPage = Number(pageAsString);
                    this.changePage();
                };
                MainPaginationComponent.prototype.changePage = function () {
                    this.pageChanged.emit(this.currentPage);
                };
                return MainPaginationComponent;
            }());
            MainPaginationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PerPageComponent = /** @class */ (function () {
                ...
                PerPageComponent.prototype.toggleIsActive = function () {
                    this.isActive = !this.isActive;
                };
                PerPageComponent.prototype.deactivate = function () {
                    this.isActive = false;
                };
                PerPageComponent.prototype.selectPerPage = function (numberAsString) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductFormComponent = /** @class */ (function () {
                function ProductFormComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                ...
                ProductFormComponent.prototype.validatePrice = function (e) {
                    if (!Number.isInteger(Number(e.target.value))) {
            ...
            var ProductForm = /** @class */ (function () {
                function ProductForm(name, imageUrl, shortDescription, longDescription, price, tag) {
                    if (name === void 0) { name = ""; }
                    if (imageUrl === void 0) { imageUrl = ""; }
                    if (shortDescription === void 0) { shortDescription = ""; }
                    if (longDescription === void 0) { longDescription = ""; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SecondaryPaginationComponent = /** @class */ (function () {
                function SecondaryPaginationComponent() {
                    this.currentPage = 1;
                    this.pageChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                SecondaryPaginationComponent.prototype.nextPage = function () {
                    if (this.currentPage < this.totalPages)
                        this.currentPage++;
                    this.changePage();
                };
                SecondaryPaginationComponent.prototype.previousPage = function () {
                    if (this.currentPage > 1)
                        this.currentPage--;
                    this.changePage();
                };
                SecondaryPaginationComponent.prototype.validatePageControl = function (e) {
                    if (!Number.isInteger(Number(e.target.value))) {
                ...
                SecondaryPaginationComponent.prototype.changePage = function () {
                    this.pageChanged.emit(this.currentPage);
                };
                return SecondaryPaginationComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SortByComponent = /** @class */ (function () {
                function SortByComponent(productsService) {
                    this.productsService = productsService;
                    this.isActive = false;
                ...
                SortByComponent.prototype.ngOnInit = function () {
                    ...
                    this.productsSubscription = this.productsService.allProductsObs$.subscribe(function () { return _this.sort(); });
                };
                SortByComponent.prototype.ngOnChanges = function () {
                    if (this.toSortArr)
                        this.sort();
                };
                SortByComponent.prototype.onResize = function () {
                    this.innerWidth = window.innerWidth;
                };
                SortByComponent.prototype.toggleIsActive = function () {
                    this.isActive = !this.isActive;
                };
                SortByComponent.prototype.deactivate = function () {
                    this.isActive = false;
                };
                SortByComponent.prototype.changeSort = function (sortName) {
                    this.currentSort = sortName.trim();
                    this.sortChanged.emit(this.currentSort);
                };
                SortByComponent.prototype.sort = function (sortName) {
                    if (!this.toSortArr)
                        return;
                    if (sortName)
                        this.currentSort = sortName;
                ...
                SortByComponent.prototype.randomize = function () {
                    var _a;
                    if (!this.toSortArr)
                        return;
                    var arr = this.toSortArr;
                ...
                SortByComponent.prototype.sortPriceAsc = function () {
                    this.toSortArr.sort(function (el1, el2) {
                        if (el1.product)
                            return (el1.product.price * el1.quantity - el2.product.price * el2.quantity);
                        return el1.price - el2.price;
                    });
                };
                SortByComponent.prototype.sortPriceDesc = function () {
                    this.toSortArr.sort(function (el1, el2) {
                        if (el1.product)
                ...
                SortByComponent.prototype.sortNameAsc = function () {
                    this.toSortArr.sort(function (el1, el2) {
                        var _a, _b;
                        if (el1.product)
                            _a = [el1.product, el2.product], el1 = _a[0], el2 = _a[1];
                        if (el1.name.lastName) {
                            _b = [el1.name.lastName, el2.name.lastName], el1 = _b[0], el2 = _b[1];
                            if (el1 > el2)
                                return 1;
                            if (el2 > el1)
                                return -1;
                ...
                SortByComponent.prototype.sortNameDesc = function () {
                    this.toSortArr.sort(function (el1, el2) {
                        var _a, _b;
                        if (el1.product)
                            _a = [el1.product, el2.product], el1 = _a[0], el2 = _a[1];
                ...
                SortByComponent.prototype.sortDateNewFirst = function () {
                    this.toSortArr.sort(function (el1, el2) { return +new Date(el1.date) - +new Date(el2.date); });
                };
                SortByComponent.prototype.sortDateOldFirst = function () {
                    this.toSortArr.sort(function (el1, el2) { return +new Date(el2.date) - +new Date(el1.date); });
                };
